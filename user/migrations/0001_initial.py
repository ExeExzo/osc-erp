    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('role', models.CharField(choices=[('EMPLOYEE', 'Сотрудник'), ('MANAGER', 'Менеджер'), ('ACCOUNTANT', 'Бухгалтер'), ('ADMIN', 'Администратор')], default='EMPLOYEE', max_length=20, verbose_name='Роль пользователя')),
